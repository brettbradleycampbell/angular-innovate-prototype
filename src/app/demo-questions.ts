...
export const QUESTIONS: Question[] = [
  {
    id: 1,
    questionText: 'Enter your question text here. Long quesiton text Long quesiton text Long quesiton text Long quesiton text Long quesiton text Long quesiton text ',
    questionGroup: 1,
